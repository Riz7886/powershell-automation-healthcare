...
$logPath  = Join-Path $reportDir "migration-v14-$stamp.log"
$jsonPath = Join-Path $reportDir "results-v14-$stamp.json"
$htmlPath = Join-Path $reportDir "PYX-AFD-Migration-Report-v14-$stamp.html"
Start-Transcript -Path $logPath -Force | Out-Null

Say "PYX AFD/CDN Migration v14 (REST + async polling + real error visibility)"
...
$profiles = @(
    @{ Classic = "pyxiq";        Standard = "pyxiq-std";        RG = "Production"; Type = "AFD"; Sku = "Premium_AzureFrontDoor" }
    @{ Classic = "hipyx";        Standard = "hipyx-std-v2";     RG = "production"; Type = "AFD"; Sku = "Premium_AzureFrontDoor" }
    @{ Classic = "pyxiq-stage";  Standard = "pyxiq-stage-std";  RG = "Stage";      Type = "AFD"; Sku = "Premium_AzureFrontDoor" }
    @{ Classic = "pyxpwa-stage"; Standard = "pyxpwa-stage-std"; RG = "Stage";      Type = "AFD"; Sku = "Premium_AzureFrontDoor" }
...
$html = @"
<!DOCTYPE html>
<html><head><meta charset="utf-8"><title>PYX Front Door Migration Report v14</title>
<style>
...
<p class="meta">Generated $reportTimestamp | Script: PYX-AFD-Migrate-v14.ps1 | API: Microsoft.Cdn 2025-04-15</p>
</body></html>
"@
