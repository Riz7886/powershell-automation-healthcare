...
Write-Host "  V4C vs V3 QUOTA ANALYSIS" -ForegroundColor Cyan
...
<body>
    <div class="container">
        <h1>V4C vs V3 Quota Analysis</h1>
...
if ($v4ViableRegions.Count -gt 0) {
    $html += @"
        <div class="success">
            ...
            <p><strong>Cost advantage:</strong> V4C is approximately 5% cheaper than V3 ($950/mo vs $1,000/mo)</p>
...
"@
    ...
    $html += @"
        <div class="warning">
            ...
            <p>V4C series has similar quota limitations as V3 across all checked regions.</p>
            <p><strong>Recommendation:</strong> Request quota increase for V4C (preferred) or V3 (fallback)</p>
            <p><strong>Why V4C preferred:</strong> Better performance, lower cost, newer generation</p>
        </div>
"@
}
        ...
        <div class="summary">
            ...
            <table style="color: white; border: none;">
                ...
                <tr>
                    ...
                    <td>Save approximately $50/month with V4C</td>
                </tr>
            </table>
        </div>
...
$html += @"
        ...
        <table>
            ...
            <tr>
                ...
                <td>Baseline</td>
                <td>Approximately 15% faster per core</td>
            </tr>
            <tr>
                <td><strong>Cost (Databricks)</strong></td>
                <td>Approximately $1,000/month</td>
                <td>Approximately $950/month (5% cheaper)</td>
            </tr>
            <tr>
                <td><strong>Quota Pool</strong></td>
                <td>Standard DSv3 Family</td>
                <td>Standard DSv4 Family (separate)</td>
            </tr>
...
if ($v4ViableRegions.Count -gt 0) {
    $html += @"
        <div class="success">
            ...
            <ol>
                <li>Create development Databricks workspace in <strong>$($bestV4Region.RegionName)</strong></li>
                <li>Use V4C VM types (Standard_D4s_v4, Standard_D8s_v4)</li>
                <li>Configure auto-scaling clusters</li>
                <li>Deploy and begin development work</li>
            </ol>
...
"@
    ...
    $html += @"
        <div class="warning">
            ...
            <ol>
                <li>Request V4C quota increase (preferred) in East US region</li>
                <li>Request amount: 128 vCPUs Standard Dv4 Family</li>
                <li>Alternative: Request V3 quota if V4C request denied</li>
                <li>Expected timeline: 2-5 business days</li>
            </ol>
            <p><strong>Why request V4C over V3:</strong> Superior performance, lower cost, newer generation technology</p>
        </div>
"@
}
...
$html += @"
        ...
        <table>
            ...
            <tr>
                <td>Current Production (V3)</td>
                <td>$1,000</td>
                <td>$12,000</td>
            </tr>
            <tr>
                <td>Development Environment with V3</td>
                <td>$346</td>
                <td>$4,152</td>
            </tr>
            <tr class="best-option">
                <td><strong>Development Environment with V4C (RECOMMENDED)</strong></td>
                <td><strong>$328</strong></td>
                <td><strong>$3,936</strong></td>
            </tr>
            <tr>
                <td>Annual Savings (V4C vs V3 Development)</td>
                <td>$18/month</td>
        ...
        <p style="margin-top: 40px; text-align: center; color: #666;">
            <strong>Analysis prepared by Syed Rizvi</strong><br>
            Infrastructure Engineering - V4C vs V3 quota and cost analysis
        </p>
    </div>
</body>
</html>
