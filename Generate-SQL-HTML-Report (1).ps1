...
$totalSavings = [Math]::Abs(($data | Measure-Object -Property PotentialSavings -Sum).Sum)
...
foreach ($db in $topSavings) {
    ...
    $html += @"
                <tr>
                    ...
                    <td class="savings-amount">`$$('{0:N2}' -f [Math]::Abs([decimal]$db.PotentialSavings))/mo</td>
                </tr>
"@
}
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="savings-amount">`$$('{0:N2}' -f [Math]::Abs(($data | Where-Object { $_.RecommendedTier -eq "Basic" } | Measure-Object -Property PotentialSavings -Sum).Sum))/mo</td>
                </tr>
                <tr>
                    ...
                    <td class="savings-amount">`$$('{0:N2}' -f [Math]::Abs(($data | Where-Object { $_.RecommendedTier -like "S*" -and $_.RecommendedTier -ne $_.ServiceObjective } | Measure-Object -Property PotentialSavings -Sum).Sum))/mo</td>
                </tr>
                <tr>
                    ...
                    <td class="savings-amount">`$$('{0:N2}' -f [Math]::Abs(($data | Where-Object { $_.RecommendedTier -like "P*" -and $_.RecommendedTier -ne $_.ServiceObjective } | Measure-Object -Property PotentialSavings -Sum).Sum))/mo</td>
                </tr>
            </table>
        </div>
    </div>
